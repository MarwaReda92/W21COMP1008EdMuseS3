...
public class Person {
    ...
    public void setFirstName(String firstName) {
        //to allow student to type into gui we need to ensure it has a clean name
        firstName = firstName.trim(); //this will clear all spaces
    ...
    public int getAge(){
        //period class is like a period of time
